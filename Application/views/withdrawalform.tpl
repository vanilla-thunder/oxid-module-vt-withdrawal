            ...
            <div class="form-group">
                ...
                <div class="col-12 col-md-6 col-xl-7">
                    <p class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" name="wdf[datenschutz]" value="1" id="datenschutzok" required [{if $smarty.post.wdf.datenschutz == "1"}]checked[{/if}]>
                        <label class="form-check-label" for="datenschutzok">
                            <b>*</b> Ich habe die <a href="[{oxgetseourl type='oxcontent' ident='oxsecurityinfo'}]" target="_blank"><u>Datenschutzbestimmungen</u></a> gelesen und akzeptiert.
                        </label>
                    </p>
                    <p>
